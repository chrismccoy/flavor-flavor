...
$badge_color = 'bg-pop-cyan';
$badge_icon  = 'fa-solid fa-newspaper';

if ( is_author() ) {
    $badge_icon = 'fa-solid fa-user-pen';
} elseif ( is_date() ) {
    $badge_icon = 'fa-solid fa-calendar-days';
}
?>
...
<section id="blog-archive" class="mb-10">
    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
        <div>
            <div class="badge <?php echo esc_attr( $badge_color ); ?> mb-3">
                <span class="<?php echo esc_attr( $badge_icon ); ?>" aria-hidden="true"></span>
                <?php esc_html_e( 'Archive', 'flavor-flavor' ); ?>
            </div>
